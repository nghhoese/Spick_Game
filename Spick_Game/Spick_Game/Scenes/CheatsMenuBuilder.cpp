...
std::shared_ptr<spic::Scene> CheatsMenuBuilder::BuildScene() {
    ...
    std::shared_ptr<spic::Text> c3 = std::make_shared<spic::Text>("ENABLE DAMAGELESS      | L-KEY", "Segment16CBold", 38, textColor, 38, 270);
    std::shared_ptr<spic::Text> c4 = std::make_shared<spic::Text>("ENABLE OBJECTS HITBOX  | O-KEY", "Segment16CBold", 38, textColor, 38, 310);
    std::shared_ptr<spic::Text> c2 = std::make_shared<spic::Text>("DISABLE COLLISION      | Q-KEY", "Segment16CBold", 38, textColor, 38, 350);
