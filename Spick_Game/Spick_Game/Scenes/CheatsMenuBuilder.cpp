...
std::shared_ptr<spic::Scene> CheatsMenuBuilder::BuildScene() {
    ...
    std::shared_ptr<spic::Text> c7 = std::make_shared<spic::Text>("UP MOVEMENT SPEED      | ARROW-KEY-UP", "Segment16CBold", 38, textColor, ((screenWidth - screenWidth) + 60), ((screenHeight - screenHeight) + 540));
    std::shared_ptr<spic::Text> c8 = std::make_shared<spic::Text>("LOWER MOVEMENT SPEED   | ARROW-KEY-DOWN", "Segment16CBold", 38, textColor, ((screenWidth - screenWidth) + 60), ((screenHeight - screenHeight) + 580));
